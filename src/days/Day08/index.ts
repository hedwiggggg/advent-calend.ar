...
// 
// generation timestamp: 1606057453555
...
import yQeCSPUvvgghfQQYZVhCxS0 from 'src/assets/day_08/frame_00_delay-0.07s.gif';
...
import SuGDPVUViedyeRvIwXePgp0 from 'src/assets/day_08/frame_03_delay-0.07s.gif';
...
import ZZAbCsttcJwzqRrbJmYUAT0 from 'src/assets/day_08/frame_21_delay-0.07s.gif';
...
export default class Day08 extends Day {
  ...
  private static framesPromises = [
    loadImage(yQeCSPUvvgghfQQYZVhCxS0),
    loadImage(fmaKQqbsZIebUkPpJCIFtUg),
    loadImage(bcLUVXTJwvwZzuWRPerWERN),
    loadImage(SuGDPVUViedyeRvIwXePgp0),
    ...
    loadImage(ZZAbCsttcJwzqRrbJmYUAT0),
