...
// 
// generation timestamp: 1606057451091
...
import PYuDejWBJdNfUkwPsdVWxu0 from 'src/assets/day_06/frame_02_delay-0.07s.gif';
import bvBzoOAEriAAeCTvFDefXei from 'src/assets/day_06/frame_03_delay-0.07s.gif';
import QvxnypPNeQGLGYwBmhpOQk0 from 'src/assets/day_06/frame_04_delay-0.06s.gif';
...
import YDtxvGwXTYATdSeWkPNXRJ0 from 'src/assets/day_06/frame_08_delay-0.07s.gif';
import dcOxzzhkCXjYHxjIODNRwCd from 'src/assets/day_06/frame_09_delay-0.07s.gif';
import ITUAccWUNzQUeAIVxyUncF0 from 'src/assets/day_06/frame_10_delay-0.06s.gif';
import UuEyZcyRxhRhoQdeuusJYs0 from 'src/assets/day_06/frame_11_delay-0.07s.gif';
import HErytAVFgATXJJdmCtcdnt0 from 'src/assets/day_06/frame_12_delay-0.07s.gif';
...
import CanPlGXpHSuPIVVJVsVuJu0 from 'src/assets/day_06/frame_28_delay-0.06s.gif';
...
import MUFezMIWTyGLxYPqkRYCKH0 from 'src/assets/day_06/frame_31_delay-0.06s.gif';
...
import MynTBFJhbeKXYMckhNeEmu0 from 'src/assets/day_06/frame_37_delay-0.06s.gif';
...
export default class Day06 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(PYuDejWBJdNfUkwPsdVWxu0),
    loadImage(bvBzoOAEriAAeCTvFDefXei),
    loadImage(QvxnypPNeQGLGYwBmhpOQk0),
    loadImage(eIjfinPhChzqdTTBpNvqUgO),
    loadImage(gaYweVnrgoNBkYHpiUMCOSn),
    loadImage(edejWrziplwKtCEyjuyJjow),
    loadImage(YDtxvGwXTYATdSeWkPNXRJ0),
    loadImage(dcOxzzhkCXjYHxjIODNRwCd),
    loadImage(ITUAccWUNzQUeAIVxyUncF0),
    loadImage(UuEyZcyRxhRhoQdeuusJYs0),
    loadImage(HErytAVFgATXJJdmCtcdnt0),
    ...
    loadImage(CanPlGXpHSuPIVVJVsVuJu0),
    loadImage(cXJRVuphxnEUzKsKAeDSfZh),
    loadImage(dMipULIEenZsOEdybjbZraL),
    loadImage(MUFezMIWTyGLxYPqkRYCKH0),
    ...
    loadImage(MynTBFJhbeKXYMckhNeEmu0),
