...
// 
// generation timestamp: 1606057461833
...
import PdtPljUdsCsoFyRCxqrrix0 from 'src/assets/day_16/frame_09_delay-0.08s.gif';
...
import vcmRlJmQbLxyajWeoNsPGg0 from 'src/assets/day_16/frame_19_delay-0.08s.gif';
...
import XBJcjAsYOfJtIoHCxdJAbF0 from 'src/assets/day_16/frame_36_delay-0.08s.gif';
...
import LXDXEjyFjJSeVdGNNWywCu0 from 'src/assets/day_16/frame_44_delay-0.08s.gif';
...
import MyktfLRJunPvCWaACVjReV0 from 'src/assets/day_16/frame_57_delay-0.08s.gif';
...
export default class Day16 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(PdtPljUdsCsoFyRCxqrrix0),
    ...
    loadImage(vcmRlJmQbLxyajWeoNsPGg0),
    ...
    loadImage(XBJcjAsYOfJtIoHCxdJAbF0),
    ...
    loadImage(LXDXEjyFjJSeVdGNNWywCu0),
    ...
    loadImage(MyktfLRJunPvCWaACVjReV0),
