...
// 
// generation timestamp: 1606057467378
...
import HJSsgoNdoKIoYKCcQkGcpK0 from 'src/assets/day_22/frame_00_delay-0.04s.gif';
...
import JwqUdWoVptDPhalBvCwehX0 from 'src/assets/day_22/frame_15_delay-0.04s.gif';
...
import WLQRlHqdZkaGbsoBRqvOIH0 from 'src/assets/day_22/frame_26_delay-0.04s.gif';
import elEGZyNAQnmwGRkVgyXbLUS from 'src/assets/day_22/frame_27_delay-0.04s.gif';
import QCgJeJHPpPRtHepMsNSLfx0 from 'src/assets/day_22/frame_28_delay-0.04s.gif';
...
export default class Day22 extends Day {
  ...
  private static framesPromises = [
    loadImage(HJSsgoNdoKIoYKCcQkGcpK0),
    ...
    loadImage(JwqUdWoVptDPhalBvCwehX0),
    ...
    loadImage(WLQRlHqdZkaGbsoBRqvOIH0),
    loadImage(elEGZyNAQnmwGRkVgyXbLUS),
    loadImage(QCgJeJHPpPRtHepMsNSLfx0),
