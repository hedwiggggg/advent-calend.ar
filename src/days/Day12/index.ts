...
// 
// generation timestamp: 1606057457796
...
import RBEmeblPZhVJrUhloDSsUD0 from 'src/assets/day_12/frame_06_delay-0.07s.gif';
import ftDYQkqdDHgRXvRPrIeZfet from 'src/assets/day_12/frame_07_delay-0.06s.gif';
import FOxiyNIAuEDvIKhWhmsIMM0 from 'src/assets/day_12/frame_08_delay-0.07s.gif';
...
import MmObQlBNBlSgdlOLZMBIce0 from 'src/assets/day_12/frame_17_delay-0.07s.gif';
...
import NqNJpULohoLCoZeVVEbsDB0 from 'src/assets/day_12/frame_29_delay-0.06s.gif';
...
export default class Day12 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(RBEmeblPZhVJrUhloDSsUD0),
    loadImage(ftDYQkqdDHgRXvRPrIeZfet),
    loadImage(FOxiyNIAuEDvIKhWhmsIMM0),
    ...
    loadImage(MmObQlBNBlSgdlOLZMBIce0),
    ...
    loadImage(NqNJpULohoLCoZeVVEbsDB0),
  ];
