...
// 
// generation timestamp: 1606057463720
...
import MFsJDMdYmSfIumjgdODalI0 from 'src/assets/day_18/frame_00_delay-0.07s.gif';
import xiJZcCMBkCaabefOrJtMYe0 from 'src/assets/day_18/frame_01_delay-0.06s.gif';
...
import KEQzpLbpZFlXopaTVpxHrD0 from 'src/assets/day_18/frame_17_delay-0.07s.gif';
import cpWLDxWmxravWGCYZkHdJcR from 'src/assets/day_18/frame_18_delay-0.07s.gif';
import QUlkNMrMsFZeZnjpJYXwhN0 from 'src/assets/day_18/frame_19_delay-0.06s.gif';
...
import yaVZXaZHoyWTBKxTKBysGs0 from 'src/assets/day_18/frame_24_delay-0.07s.gif';
...
import SbgNLvtKoQmNXODNtduodb0 from 'src/assets/day_18/frame_37_delay-0.06s.gif';
...
import OdhpLiRmysRNkJtknoGZhH0 from 'src/assets/day_18/frame_42_delay-0.07s.gif';
...
import yYTygxKuMMkKVQxLmLIlLS0 from 'src/assets/day_18/frame_54_delay-0.07s.gif';
import cSkpHlVvklfbPKUSfWCelaU from 'src/assets/day_18/frame_55_delay-0.06s.gif';
import YTtzYCCszHWIygPAcixqPN0 from 'src/assets/day_18/frame_56_delay-0.07s.gif';
...
export default class Day18 extends Day {
  ...
  private static framesPromises = [
    loadImage(MFsJDMdYmSfIumjgdODalI0),
    loadImage(xiJZcCMBkCaabefOrJtMYe0),
    ...
    loadImage(KEQzpLbpZFlXopaTVpxHrD0),
    loadImage(cpWLDxWmxravWGCYZkHdJcR),
    loadImage(QUlkNMrMsFZeZnjpJYXwhN0),
    ...
    loadImage(yaVZXaZHoyWTBKxTKBysGs0),
    ...
    loadImage(SbgNLvtKoQmNXODNtduodb0),
    ...
    loadImage(OdhpLiRmysRNkJtknoGZhH0),
    ...
    loadImage(yYTygxKuMMkKVQxLmLIlLS0),
    loadImage(cSkpHlVvklfbPKUSfWCelaU),
    loadImage(YTtzYCCszHWIygPAcixqPN0),
