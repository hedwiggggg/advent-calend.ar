...
// 
// generation timestamp: 1606057450069
...
import wmKHgwOIOEnhTzpYEYbSlo0 from 'src/assets/day_05/frame_17_delay-0.08s.gif';
...
import SgotKotcXHwzWWXlJkqJyR0 from 'src/assets/day_05/frame_22_delay-0.08s.gif';
...
import EDhlGqzlKMfyZceqNmXHUc0 from 'src/assets/day_05/frame_31_delay-0.08s.gif';
...
export default class Day05 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(wmKHgwOIOEnhTzpYEYbSlo0),
    ...
    loadImage(SgotKotcXHwzWWXlJkqJyR0),
    ...
    loadImage(EDhlGqzlKMfyZceqNmXHUc0),
  ];
