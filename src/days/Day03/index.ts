...
// 
// generation timestamp: 1606057447801
...
import zvUShyBURhZPTKPnVIQHRE0 from 'src/assets/day_03/frame_19_delay-0.05s.gif';
import HgQVmmsZdQrWUEvYhgEXzJ0 from 'src/assets/day_03/frame_20_delay-0.05s.gif';
import DFLdhYmwUbmbxVGvzUXQsQ0 from 'src/assets/day_03/frame_21_delay-0.05s.gif';
import bXVJcGuXVynmtwfjmWZkBWY from 'src/assets/day_03/frame_22_delay-0.05s.gif';
import YfgVqBVnAfcIqYyeBDRBEo0 from 'src/assets/day_03/frame_23_delay-0.05s.gif';
import bcscOhGScMpQYNWruEROLte from 'src/assets/day_03/frame_24_delay-0.05s.gif';
import WImDQweGwgeataooraahUq0 from 'src/assets/day_03/frame_25_delay-0.05s.gif';
import eMYescPNKDHkSVDBIswDKAN from 'src/assets/day_03/frame_26_delay-0.05s.gif';
import KmBFhvKKUHoXeqUvklfsSG0 from 'src/assets/day_03/frame_27_delay-0.05s.gif';
...
import CLkJCLwsgPLiKIuSjRvPcT0 from 'src/assets/day_03/frame_34_delay-0.05s.gif';
...
import TUUXIPUfwOnhyWXbWjGowA0 from 'src/assets/day_03/frame_40_delay-0.05s.gif';
import fqNULYQACGaAubcoFiGzhHv from 'src/assets/day_03/frame_41_delay-0.05s.gif';
import vYYWXVYnuSKVQyRVGWawBo0 from 'src/assets/day_03/frame_42_delay-0.05s.gif';
...
import vOrSBmrMuNMzhbcWZYcanF0 from 'src/assets/day_03/frame_56_delay-0.05s.gif';
...
export default class Day03 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(zvUShyBURhZPTKPnVIQHRE0),
    loadImage(HgQVmmsZdQrWUEvYhgEXzJ0),
    loadImage(DFLdhYmwUbmbxVGvzUXQsQ0),
    loadImage(bXVJcGuXVynmtwfjmWZkBWY),
    loadImage(YfgVqBVnAfcIqYyeBDRBEo0),
    loadImage(bcscOhGScMpQYNWruEROLte),
    loadImage(WImDQweGwgeataooraahUq0),
    loadImage(eMYescPNKDHkSVDBIswDKAN),
    loadImage(KmBFhvKKUHoXeqUvklfsSG0),
    ...
    loadImage(CLkJCLwsgPLiKIuSjRvPcT0),
    ...
    loadImage(TUUXIPUfwOnhyWXbWjGowA0),
    loadImage(fqNULYQACGaAubcoFiGzhHv),
    loadImage(vYYWXVYnuSKVQyRVGWawBo0),
    ...
    loadImage(vOrSBmrMuNMzhbcWZYcanF0),
  ];
