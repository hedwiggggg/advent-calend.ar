...
// 
// generation timestamp: 1606057456764
...
import xXfWXKAIpMkTOwfbvRZwOS0 from 'src/assets/day_11/frame_04_delay-0.13s.gif';
import fXElesYALuxNZKDBWWRTjjY from 'src/assets/day_11/frame_05_delay-0.13s.gif';
import KElNdLunQcuNUpNwXoVnmh0 from 'src/assets/day_11/frame_06_delay-0.13s.gif';
import fQqTALYYgXcCsZrkfBRbqrZ from 'src/assets/day_11/frame_07_delay-0.13s.gif';
import RvMNMoLrSKeSnwtEnyLJET0 from 'src/assets/day_11/frame_08_delay-0.13s.gif';
...
import DqelOGejTvvWfDJCAXHCFM0 from 'src/assets/day_11/frame_22_delay-0.13s.gif';
...
import HNpanoilrXgRsJQVKluwSB0 from 'src/assets/day_11/frame_29_delay-0.13s.gif';
...
export default class Day11 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(xXfWXKAIpMkTOwfbvRZwOS0),
    loadImage(fXElesYALuxNZKDBWWRTjjY),
    loadImage(KElNdLunQcuNUpNwXoVnmh0),
    loadImage(fQqTALYYgXcCsZrkfBRbqrZ),
    loadImage(RvMNMoLrSKeSnwtEnyLJET0),
    ...
    loadImage(DqelOGejTvvWfDJCAXHCFM0),
    ...
    loadImage(HNpanoilrXgRsJQVKluwSB0),
