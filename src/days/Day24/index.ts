...
// 
// generation timestamp: 1606057469518
...
import MVlcNeEJeFMGkuZQaxWRfV0 from 'src/assets/day_24/frame_02_delay-0.1s.gif';
...
import RYAZdKBnGaGIVfvKHCQyIY0 from 'src/assets/day_24/frame_22_delay-0.1s.gif';
import ZVPLRylJDwJcskoUPiiUZa0 from 'src/assets/day_24/frame_23_delay-0.1s.gif';
...
export default class Day24 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(MVlcNeEJeFMGkuZQaxWRfV0),
    ...
    loadImage(RYAZdKBnGaGIVfvKHCQyIY0),
    loadImage(ZVPLRylJDwJcskoUPiiUZa0),
