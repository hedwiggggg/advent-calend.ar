...
// 
// generation timestamp: 1606057458663
...
import VBTGcqgIsWqyMSJJjEjBph0 from 'src/assets/day_13/frame_009_delay-0.04s.gif';
...
import CdfDnJwiSLiGcuGJTbSNgL0 from 'src/assets/day_13/frame_012_delay-0.04s.gif';
import YyZTXmrlQcYQPiwkjdDdjj0 from 'src/assets/day_13/frame_013_delay-0.05s.gif';
...
import ZhYICAvpsimGllHMWowhfK0 from 'src/assets/day_13/frame_026_delay-0.05s.gif';
...
import TcErFHOhLZWwWnnJqSOGhz0 from 'src/assets/day_13/frame_029_delay-0.04s.gif';
import KVbIeCALusxsFAYSuUhRuk0 from 'src/assets/day_13/frame_030_delay-0.05s.gif';
import GSAnlYhVyEiiuPLDIgnaqF0 from 'src/assets/day_13/frame_031_delay-0.04s.gif';
...
import UBmVYByZkWkpXAReCcnMEu0 from 'src/assets/day_13/frame_045_delay-0.04s.gif';
...
import TnTZyTUGPrTvCKDoWoAvfn0 from 'src/assets/day_13/frame_074_delay-0.05s.gif';
import fhEdFJdCUHcFqHIfefSRNJS from 'src/assets/day_13/frame_075_delay-0.04s.gif';
import ZTzvlUjvNdHDnbCUCtolvW0 from 'src/assets/day_13/frame_076_delay-0.05s.gif';
...
import uGsDEUvRIDdMrIjTLRAZgl0 from 'src/assets/day_13/frame_079_delay-0.05s.gif';
...
import UmSMmJYGaAIjZDnpmEDQha0 from 'src/assets/day_13/frame_085_delay-0.05s.gif';
...
import VbKLMKhkrFZwLoRlhggbQK0 from 'src/assets/day_13/frame_092_delay-0.05s.gif';
...
import STbdMpagZgligVTGyOYoou0 from 'src/assets/day_13/frame_096_delay-0.05s.gif';
...
import EQzMYXBlGbnFZgzgSuyEEj0 from 'src/assets/day_13/frame_109_delay-0.05s.gif';
import TmOTxkZmTSkZhiVORtGnSn0 from 'src/assets/day_13/frame_110_delay-0.05s.gif';
...
export default class Day13 extends Day {
  ...
  private static framesPromises = [
    ...
    loadImage(VBTGcqgIsWqyMSJJjEjBph0),
    loadImage(cOMKsVsnAeIkzpTKDRqmZIf),
    loadImage(fjFKTxKDBbExgjjhRERBRuH),
    loadImage(CdfDnJwiSLiGcuGJTbSNgL0),
    loadImage(YyZTXmrlQcYQPiwkjdDdjj0),
    ...
    loadImage(ZhYICAvpsimGllHMWowhfK0),
    loadImage(fIfOSGkydxmwsKIMICqjRbf),
    loadImage(dUByiXZYZQihxthrdzTKrMV),
    loadImage(TcErFHOhLZWwWnnJqSOGhz0),
    loadImage(KVbIeCALusxsFAYSuUhRuk0),
    loadImage(GSAnlYhVyEiiuPLDIgnaqF0),
    ...
    loadImage(UBmVYByZkWkpXAReCcnMEu0),
    ...
    loadImage(UmSMmJYGaAIjZDnpmEDQha0),
    ...
    loadImage(EQzMYXBlGbnFZgzgSuyEEj0),
    loadImage(TmOTxkZmTSkZhiVORtGnSn0),
  ];
